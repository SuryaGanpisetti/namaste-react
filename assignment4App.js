    ...
    <div className="header">
      <div className="logo-container">
        <img
          className="logo"
          alt="Food App Logo"
          src="https://img.freepik.com/premium-vector/logo-food-ordering-company-with-fork-speech-bubble-logo-lunch-delivery_1107171-4493.jpg?semt=ais_hybrid"
        />
      </div>
  ...
  return resMenuData.map((menu) => (
    <div className="res-card" style={styleCard} key={menu.resName}>
      <img
        className="res-logo"
        alt="res-logo"
        src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/6d8627d8366cf0a4f0fc7acd01166ee9"
      />
